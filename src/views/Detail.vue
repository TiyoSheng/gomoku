              ...
              <div class="flex-center">
                ...
                <div class="info">
                  <div v-if="!winner" class="down-time"><span
                      :style="{ color: nowPlayer == 2 ? '#FED863' : 'rgba(255, 255, 255, 0.20)' }">{{ nowPlayer == 2 ?
                        block
                      : '00' }}</span>Blocks</div>
                  <div v-else class="result" :style="{ color: winner == 2 ? '#9DFF85' : '#FF6161' }">{{ winner == 2 ?
                    'Win'
                    : 'Loss' }}</div>
            ...
            <div class="user-info">
              <div class="flex-center">
                <div class="info">
                  ...
                  <div v-else class="result" :style="{ color: winner == 1 ? '#9DFF85' : '#FF6161' }">{{ winner == 1 ?
                    'Win'
                    : 'Loss' }}</div>
      ...
      <div class="r-bd">
        ...
        <div class="tx-w">
          <div class="tx" v-for="(item, index) in txList">
            ...
            <span v-if="item.tx?.hash" @click="toScan(item.tx?.hash)" class="tx-hash">tx: {{
              formatAddress(item.tx?.hash)
              }}</span>
