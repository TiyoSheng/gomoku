...
export async function init_wallet() {
  let rpc_url = "https://eth-goerli.g.alchemy.com/v2/xQr0n2BqF1Hkkuw5_0YiEXeyQdSYoW1u";
  ...
  //  privateKey =
  //   "9f0b7fda7aa3e9bb0e3f4c2859996bd2524610963f50953d5ad3c33b9bca30e0";
...
export async function create_aa_wallet() {
  ...
  const FactoryAddress = "0x3647fABd9F0a8CF5CCd9246Cd559BB2E40a8c43F"
  ...
  console.log(t)
  let aa_address = await factory.getAddress(wallet_address, salt);
